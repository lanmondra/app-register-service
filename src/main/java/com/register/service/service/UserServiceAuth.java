...
import com.register.service.interfaces.IUserServiceAuth;
...
import com.register.service.service.errors.IBaseUserServiceErrorCode;
import com.register.service.service.errors.IValidatorServiceErrorCode;
...
public class UserServiceAuth extends AbstractService implements IUserServiceAuth {
	...
	private final ProvinceTownService provinceTownService;
	...
	public UserServiceAuth(AuthenticationManager authenticationManager, BaseUserRepository baseUserRepository,
						   ...
						   ProvinceTownService provinceTownService) {
		super();
		...
		this.provinceTownService = provinceTownService;
	}
	...
	public UserDTO signUp(SignUpRequestDto signUpRequestDto) {
		...
		provinceTownService.findTownByid(signUpRequestDto.getTownCode());
		...
		baseUser.setTownCode(signUpRequestDto.getTownCode());
