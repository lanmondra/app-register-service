...
public class AuthController {
	...
	private IUserServiceAuth iUserServiceAuth;

	public AuthController(UserServiceAuth iUserServiceAuth) {
		super();
		this.iUserServiceAuth = iUserServiceAuth;
	}
	...
	public ResponseEntity<JwtResponse> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		JwtResponse jwtResponse = iUserServiceAuth.login(loginRequest);
	...
	public ResponseEntity<UserDTO> registerUser(@Valid @RequestBody SignUpRequestDto signUpRequest) {
		...
		UserDTO baseUser = iUserServiceAuth.signUp(signUpRequest);
